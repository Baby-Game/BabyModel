...
public class LanguageManager {
    private final HashMap<ProxiedPlayer, String> playerLanguageMap = new HashMap<>(); // Utilisation de String pour le code de la langue
    ...
    public HashMap<ProxiedPlayer, String> getPlayerLanguageMap() {
    ...
    public String getTranslation(ProxiedPlayer player, String key) {
